...
namespace Io.Rz.FlywheelComponents.Chunking
{
    ...
    */
    ...
    /// <summary>
    ///  Implemntation of the BuzHash algorithm (http://en.wikipedia.org/wiki/Rolling_hash#Cyclic_polynomial)
    /// 
    ...
    public class BuzHashFunction
    {
        ...
        /// <summary>
        /// Gets the underlying bytes from the string (not encoding, just the realy implementation of how it's stored)
    ...
    public static class UIntExtensions
    {
        ...
        /// <returns></returns>
        public static uint BSL(this uint value, int count)
        {
        ...
        /// <param name="count"></param>
        /// <returns></returns>
        public static uint BSR(this uint value, int count)
        {
            return (value >> count) | (value << (32 - count));
        }
    }
